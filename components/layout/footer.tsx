...
export function Footer() {
  ...
  return (
    <footer className="section-dark relative overflow-hidden text-white">
      ...
      <div className="container relative z-10 mx-auto px-4 py-14 lg:px-8 lg:py-16">
        <div className="grid gap-10 border-t border-white/10 pt-10 lg:grid-cols-[1.2fr_0.75fr_0.75fr_0.9fr]">
          <div>
            <Link href="/" className="inline-flex items-center gap-4">
              ...
              <div>
                ...
                <span className="mt-1 block text-[0.66rem] uppercase tracking-[0.28em] text-white/42">
                  Desarrollo web y sistemas
                </span>
              </div>
            </Link>

            <h3 className="mt-8 max-w-[14ch] text-3xl font-extrabold tracking-[-0.05em] text-white">
              Diseñamos presencia digital y software para empresas que quieren verse serias.
            </h3>
            <p className="mt-4 max-w-lg text-base leading-relaxed text-white/64">
              Web corporativa, aplicaciones internas, dashboards, automatización e integraciones
              dentro de una misma lógica: claridad visual, criterio técnico y confianza empresarial.
            </p>
          </div>
            ...
            <div className="mt-6 flex items-center gap-3">
              {[
                ...
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center border border-white/10 bg-white/[0.04] text-white/72 transition-all duration-300 hover:-translate-y-0.5 hover:border-primary/28 hover:text-white"
                  aria-label={label}
                >
        ...
        <div className="mt-10 flex flex-col items-start justify-between gap-4 border-t border-white/10 pt-6 text-sm text-white/42 lg:flex-row lg:items-center">
