...
export function CTA() {
  return (
    <section id="cta-home" className="section-dark relative overflow-hidden pt-10 text-white">
      <div className="absolute left-[-10rem] top-10 h-[24rem] w-[24rem] rounded-full bg-[radial-gradient(circle,rgba(59,130,246,0.06),transparent_70%)] blur-3xl" />

      <div className="container relative z-10 mx-auto px-4 lg:px-8">
        <Parallax offset={18}>
          <div className="overflow-hidden rounded-[1rem] border border-white/10 bg-[linear-gradient(135deg,rgba(18,20,24,0.96),rgba(8,9,11,0.98))]">
          <div className="grid lg:grid-cols-[1.08fr_0.92fr]">
            <div className="relative overflow-hidden px-7 py-12 sm:px-10 lg:px-12 lg:py-14">
              ...
              <div className="absolute inset-y-0 left-0 w-[44%] bg-[radial-gradient(circle_at_left,rgba(59,130,246,0.06),transparent_72%)]" />

              <Reveal className="section-chip text-[0.74rem] font-semibold uppercase tracking-[0.26em] text-primary">
              ...
              <Reveal delay={0.08} className="relative mt-6 max-w-2xl text-lg leading-relaxed text-white/66">
              ...
              <Reveal delay={0.16} className="relative mt-10 flex flex-col gap-4 sm:flex-row">
                ...
                <Button asChild variant="outline" size="lg" className="border-white/12 bg-white text-[#111318] hover:bg-[#F8FAFC] sm:w-auto">
                  <Link href="/proyectos">Ver casos de trabajo</Link>
                </Button>
              </Reveal>

              <StaggerGroup delayChildren={0.12} stagger={0.07} className="relative mt-10 grid gap-4 border-t border-white/10 pt-6 sm:grid-cols-3">
                {[
                  "Más claridad comercial",
                  "Más confianza visual",
                  "Más orden operativo",
                ].map((item) => (
                  <StaggerItem key={item} className="border-l border-white/10 pl-4">
            ...
            <Reveal delay={0.08} className="relative border-t border-white/10 px-7 py-10 sm:px-8 lg:border-t-0 lg:px-10 lg:py-12">
              ...
              <StaggerGroup delayChildren={0.1} stagger={0.07} className="mt-8 space-y-4">
                <StaggerItem>
                  <a
              ...
              <StaggerGroup delayChildren={0.16} stagger={0.07} className="mt-8 grid gap-5 border-t border-white/10 pt-6">
                {[
