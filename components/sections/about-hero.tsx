  ...
  return (
    <section className="section-light relative overflow-hidden pt-32 pb-20">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute left-0 top-0 h-[20rem] w-[20rem] rounded-full bg-[radial-gradient(circle,rgba(255,122,26,0.18),transparent_68%)] blur-3xl" />
        <div className="absolute right-0 top-12 h-[16rem] w-[16rem] rounded-full bg-[radial-gradient(circle,rgba(255,229,205,0.9),transparent_68%)] blur-3xl" />
      </div>
      ...
      <div className="container relative z-10 mx-auto px-4 lg:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          ...
          >
            ...
            <div className="mt-8 paper-card rounded-[1.8rem] p-6">
          ...
          <motion.div
            ...
            className="surface-card rounded-[2.4rem] p-5 lg:p-6"
          >
            <div className="paper-card rounded-[1.9rem] p-6 lg:p-7">
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-2">
                {stats.map((stat) => (
                  <div key={stat.label} className="paper-card-soft rounded-[1.4rem] p-5">
              ...
              <div className="ink-panel mt-6 rounded-[1.6rem] p-6 text-white">
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-3">
                  {[
                    ...
                    <div
                      key={item}
                      className="rounded-[1.1rem] border border-white/10 bg-white/[0.05] px-4 py-3 text-sm text-white/80"
                    >
                      {item}
                    </div>
                  ))}
